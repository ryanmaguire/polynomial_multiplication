 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Computes P += A*B for polynomials with integer coefficients.          *
 ******************************************************************************
 *                             DEFINED FUNCTIONS                              *
 ******************************************************************************
 *  Function Name:                                                            *
 *      Naive_AddTo_Product                                                   *
 *  Purpose:                                                                  *
 *      Computes P += A*B where multiplication is performed the naive way.    *
 ...
 *      None.                                                                 *
 *  Method:                                                                   *
 *      Perform the product using the Cauchy product method.                  *
 *  Notes:                                                                    *
...
/*  Function for computing P += A*B for integer polynomials. This method      *
 *  assumes A_len <= B_len.                                                   */
void
